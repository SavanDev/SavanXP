/*
 * SavanXP overlay: the Linux port intentionally disables Doom networking.
 * This adapter is part of SavanXP and is distributed under the repository
 * license; it is not an upstream DoomGeneric source file.
 */

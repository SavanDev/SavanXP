 ...
 * (kernel/native_syscall_dispatch.inc) como el runtime de userland
...
/* e_ident[EI_OSABI] value for SavanXP native executables. */
#define SXN_ELF_OSABI_NATIVE 0x53u /* 'S' de SavanXP */
